...
def estoque_produtos(*listas):
    lista_produto = []
    for lista in listas:
        for produto, estoque in lista:
            lista_produto.append(produto)
    lista_produto = set(lista_produto)
    lista_produto = list(lista_produto)
    return lista_produto

# Estoque dos primeiros 4 meses
...
# Aplicando os resultados, com as listas fornecidas

print (estoque_produtos(estoque_fim_jan, estoque_fim_fev, estoque_fim_mar, estoque_fim_abr))
print (len(estoque_produtos(estoque_fim_jan, estoque_fim_fev, estoque_fim_mar, estoque_fim_abr)))
