...
//inserindo os dados temporários do formulário com a superglobal $_POST;
...
?>
<?php
//Definindo variáveis de conexão com o DB;
...
echo "<br>*Banco de dados mydb criado.";
} else {
